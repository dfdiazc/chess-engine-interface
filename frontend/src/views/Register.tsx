...
const Register = () => {
  return (
    <div className="bg-white px-10 py-6 relative rounded-xl self-center w-full max-w-sm z-10">
      ...
      <div className="font-roboto fonto-normal text-gray-800 text-sm">
        ...
        <Link to="/login" className="select-none text-blue-500 hover:underline">
          Start playing chess!
        </Link>
      </div>
    </div>
